# 💻 2025-1 AI+X 선도인재양성 중급프로젝트 (with KT)

2025-1 학기 **AI+X 선도인재양성 중급프로젝트 with KT** 과정에서 수행한 ML 과제/프로젝트를 정리한 레포지토리입니다.  
초급에서 EDA로 데이터의 특징을 이해했다면, 중급에서는 **머신러닝 모델링 및 단계별 파이프라인 설계**를 통해 예측 성능을 개선하는 흐름으로 확장했습니다.

## What’s inside

- **01 | 스마트폰 센서 데이터 예측 모델 개발 (Team Project)**  
  스마트폰 센서 데이터 기반 인간 행동(HAR) 분류 모델을 개발하고,  **기본 모델링 vs 단계별(2-stage) 모델링**을 비교
